...
void ADC_Init() {
  ...
  ADC0->ULLMEM.MEMCTL[0] = (2<<8) | 2; // PA25
  ADC0->ULLMEM.MEMCTL[1] = (2<<8) | 3; // PA24
  ADC0->ULLMEM.MEMCTL[2] = (2<<8) | 5; // PB24
  ADC0->ULLMEM.MEMCTL[3] = (2<<8) | 7; // PA22
  ADC1->ULLMEM.MEMCTL[0] = (2<<8) | 3; // PA17
  ADC1->ULLMEM.MEMCTL[1] = (2<<8) | 5; // PA18
